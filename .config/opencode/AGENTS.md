...
If the command is likely to take longer than 1 minute (e.g., `flatpak-builder`, `cargo build`, `npm run build`), 
...
If you find the contents of a file to be different from what you
expect, it may be an editing error, but you should never assume this.
It is more likely that the user has deliberately edited the file
to improve your code.  If in doubt, ask the user.
